...
export const UI = {
  ...
  ITEM_CARD: 'item-card',
  TUTORIAL_BOARD: 'tutorial-board',
  TUT_CONTROLS: 'tut-controls',
  TUT_UI: 'tut-ui',
  TUT_WORLD_ELEMENTS: 'tut-world-elements',
  QUEST_UI: 'quest-ui',
  ...
  MISC_PREV_BTN: 'misc-prev-btn',
  MISC_NEXT_BTN: 'misc-next-btn',
  MISC_PREV_DIS_BTN: 'misc-prev-dis-btn',
  MISC_NEXT_DIS_BTN: 'misc-next-dis-btn',
