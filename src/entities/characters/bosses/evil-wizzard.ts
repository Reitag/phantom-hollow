...
export class EvilWizzard extends Character {
  constructor({ scene, position, keyName, frame, facingRight, stats }: CharacterConfig) {
    ...
    this.animations = {
      ...
      [CHARACTER_ANIMATION_KEYS.MOVE]: BOSSES_ANIMATION.EVIL_WIZARD.MOVE,
      [CHARACTER_ANIMATION_KEYS.RUN]: BOSSES_ANIMATION.EVIL_WIZARD.RUN,
      [CHARACTER_ANIMATION_KEYS.CAST.CAST_START]: BOSSES_ANIMATION.EVIL_WIZARD.CAST_START,
      [CHARACTER_ANIMATION_KEYS.CAST.CAST_MAIN]: BOSSES_ANIMATION.EVIL_WIZARD.CAST_MAIN,
      [CHARACTER_ANIMATION_KEYS.CAST.CAST_END]: BOSSES_ANIMATION.EVIL_WIZARD.CAST_END,
    ...
    this.stateMachine.addState(new Death(this, CHARACTERS.EVIL_WIZARD, 89));
